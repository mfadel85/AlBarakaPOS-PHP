...
<body>
    <div class="container">
    	...
    	?>
        <form class="form-horizontal" id="PostToMPI" action="prepareForm2.php" method="Post" name="PostToMPI" role="form" accept-charset="UTF-8">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                                ...
                                <div class="col-md-10">
									...
									2.	Sanal POS üzerinden  <img src="bonus.png" height='15' width='80'>  olarak <span style="text-decoration: underline;    font-weight: 800; ">sadece</span> Türkiye Finans Katılım Bankası kartları çekilebilmektedir. <br>
									
									3.	Diğer <img src="bonus.png" height='15' width='80'> özellikli tüm bankaların kredi kartlarını ise 0212 275 30 36 nolu telefondan bize ulaşarak Mail Order ile peşin fiyatına 3 ve 5 Taksit “0” komisyon ile çektirebilirsiniz. </div>
